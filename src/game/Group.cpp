    ...
    if(save && !isBGGroup())
    {
        ...
        if(bind.save)
        {
            ...
            if(permanent != bind.perm || save != bind.save)
                ...
                CharacterDatabase.PExecute("REPLACE INTO group_instance (leaderGuid, instance, permanent) VALUES ('%u', '%u', '%u')", GUID_LOPART(GetLeaderGUID()), save->GetInstanceId(), permanent);
