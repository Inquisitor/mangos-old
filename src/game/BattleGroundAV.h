...
/*
 * some of my findings:
 * below.. sorry for german strings but don't know what happened when the sound came
8212:
    alliance grave assault
    alliance tower assault
    drek "mlanzenabschaum! In meiner Burg?! Toetet sie all" - not allways
8333:
...
enum BG_AV_DB_Creatures
{
    ...
    AV_CREATURE_MARSHAL     = 7,                            // 4alliance marshals + 4 horde marshals their ids are similar to those of the tower - ids (only here)
...
class BattleGroundAV : public BattleGround
{
    ...
    public:
       ...
       void UpdatePlayerScore(Player *Source, uint32 type, uint32 value);
        ...
        /*handlestuff*/ // these are functions which get called from extern scripts
